...
<body background="imagens/background.gif">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-info border border-info rounded-3" href="sobre.php">Sobre</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="p-3 text-light rounded-3" style="font-family: 'Courier New', monospace;">
        ...
        <p class="fs-4 text-start text-break" style="padding-left: 50px; padding-right: 400px;">Projetado por: João
            Pedro Pereira -
            2024 0331 4703 -</p>
        ...
        <p class="fs-6 text-start text-break" style="padding-left: 50px; padding-right: 400px;">Gameaval é um projeto de
            ...
            quanto das histórias por eles contadas</p>
    </div>
